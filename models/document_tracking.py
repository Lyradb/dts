...
class DtsDocument(models.Model):
    ...
    sender_id = fields.Many2one(comodel_name="hr.employee", string="Sender",default=lambda self: self.env.uid, readonly=True)
    sender_office_id = fields.Many2one(comodel_name="hr.department", string="Sender Office", related = 'sender_id.department_id', readonly=True)
